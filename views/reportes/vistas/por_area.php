<?php
// views/reportes/vistas/por_area.php
// Variables: $resultados, $filtros
?>
    ...
    <table class="table table-bordered table-striped" width="100%" cellspacing="0">
        ...
        <tbody>
            <?php if (empty($resultados)): ?>
                <tr>
                    <td colspan="6" class="text-center">No se encontraron empleados activos con saldos en esta unidad.</td>
                </tr>
            <?php else: ?>
