...
$controllerName = isset($_GET['controller']) ? filter_var(ucfirst(strtolower($_GET['controller'])), FILTER_SANITIZE_STRING) : 'Dashboard';
$actionName = isset($_GET['action']) ? filter_var(strtolower($_GET['action']), FILTER_SANITIZE_STRING) : 'index';
